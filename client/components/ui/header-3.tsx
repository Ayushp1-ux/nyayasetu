...
const serviceLinks: LinkItem[] = [
	{
		...
		href: '/ai-assistant',
		description: 'Get instant legal answers with AI',
		icon: Sparkles,
	},
	{
		title: 'Find Lawyers',
	...
	},
	{
		title: 'Case Strategy',
		href: '/case-strategy',
		description: 'Plan your legal approach',
		icon: Briefcase,
	},
	{
		title: 'Legal Notice',
		href: '/legal-notice',
		description: 'Generate legal notices instantly',
		icon: FileText,
	},
	{
		title: 'Cost Estimator',
		href: '/cost-estimator',
		description: 'Calculate legal costs upfront',
		icon: Calculator,
	},
	{
		title: 'Case Search',
...
const companyLinks: LinkItem[] = [
	{
		title: 'About Us',
		href: '#about',
		description: 'Learn more about NyayaPath',
		icon: Users,
	},
	{
...
const NyayaPathIcon = (props: React.ComponentProps<"svg">) => (
